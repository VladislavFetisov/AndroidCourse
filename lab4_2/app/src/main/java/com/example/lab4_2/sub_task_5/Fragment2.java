...
public class Fragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView.findViewById(R.id.to_firstFragment).setOnClickListener(v -> {
            NavHostFragment.findNavController(Fragment2.this).navigate(R.id.action_fragment2_to_fragment1);
        });
        rootView.findViewById(R.id.to_thirdFragment).setOnClickListener(v -> {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.go_to_about) {
            NavHostFragment.findNavController(Fragment2.this).navigate(R.id.activityAbout2);
            return true;
        }
